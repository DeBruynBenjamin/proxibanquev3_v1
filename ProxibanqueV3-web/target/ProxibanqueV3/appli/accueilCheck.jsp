  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
      ...
      <div id="navbar2" class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
      		<li style="padding-right:34em;"><a href="appli/accueil.jsp"><span class="glyphicon glyphicon-user"></span> <strong><c:out value= "${cons.prenomCons}"/> <c:out value= "${cons.nomCons}"/></strong></a></li>
      	</ul>
      </div>
      <!--/.nav-collapse -->
    </div>
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 tomove">
	 ...
	 <c:if test="${validmodifs == 'Les modifications ont bien été prises en compte.'}">
	  ...
	  <br>	
	  <form action="appli/accueil" method = "POST" name="form1">
