...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-10 tomove">
		<div class="jumbotron">
		    <h1>ERREUR 400</h1>      
		    <p>La requête HTTP n'a pas pu être comprise par le serveur en raison d'une syntaxe erronée. Relancez l'application et/ou contacter votre administrateur.</p>
	  	</div>
		<br>
